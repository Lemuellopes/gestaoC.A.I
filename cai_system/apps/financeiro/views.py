...
from .services import processar_rotina_financeira


def gerar_cobrancas_do_mes(mes, ano):
    processar_rotina_financeira(mes, ano)
...
def dashboard_financeiro(request):
    ...
    gerar_cobrancas_do_mes(mes, ano)
...
def nova_mensalidade(request):
    messages.info(
        request,
        'As mensalidades são geradas automaticamente com base no plano definido na matrícula.'
    )
