...
class MatriculaInline(admin.TabularInline):
    model = Matricula
    fields = (
        'aluno', 'status', 'data_inicio', 'plano', 'frequencia_semanal', 'dia_vencimento',
        'cobranca_personalizada', 'valor_personalizado', 'valor_mensalidade'
    )
    extra = 0
...
class MatriculaAdmin(admin.ModelAdmin):
    list_display = (
        'aluno', 'turma', 'status', 'plano', 'frequencia_semanal', 'dia_vencimento',
        'cobranca_personalizada', 'data_inicio', 'valor_mensalidade'
    )
    list_filter = ('status', 'plano', 'frequencia_semanal', 'cobranca_personalizada', 'turma__faixa_etaria')
