"""
Django settings for CAI - Centro Aquático Infantil
Instituto Tia Duda
"""
...
SECRET_KEY = 'django-insecure-cai-instituto-tia-duda-change-in-production'
...
INSTALLED_APPS = [
    # Jazzmin antes do django.contrib.admin
    'jazzmin',
...
# Jazzmin - Django Admin Customizado
JAZZMIN_SETTINGS = {
    "site_title": "CAI Admin",
    "site_header": "Centro Aquático Infantil",
    "site_brand": "C.A.I",
    "site_logo": None,
    "welcome_sign": "Bem-vindo ao Sistema Administrativo do C.A.I",
    "copyright": "Instituto Tia Duda",
    "search_model": ["accounts.Usuario", "alunos.Aluno"],
    "topmenu_links": [
        {"name": "Portal", "url": "/", "permissions": ["auth.view_user"]},
    ],
    "show_sidebar": True,
    ...
    "order_with_respect_to": [
        "accounts", "alunos", "professores", "turmas", "financeiro"
    ],
}
